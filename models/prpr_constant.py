...
class PRPR_Constant_Precisions(OdeModel):
    ...
    def initialize_state(self, theta, _treatments):
        ...
        x0 = torch.stack([theta.init_x, theta.init_rfp, theta.init_yfp, theta.init_cfp, zero, zero, theta.init_prec_x, theta.init_prec_rfp, theta.init_prec_yfp, theta.init_prec_cfp], axis=2)
        return x0
